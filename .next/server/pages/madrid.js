...
const index = ({ ciudad , general , tienda1 , tienda2 , tienda3 , tienda4 , tienda5 , tienda6 , tienda7 , tienda8 , tienda9 , tienda10 , tienda11 , tienda1Google , tienda2Google , tienda3Google , tienda4Google , tienda5Google , tienda6Google , tienda7Google , tienda8Google , tienda9Google , tienda10Google , tienda11Google  })=>{
    const arrayTiendas = [
        ...
        },
        {
            ...
            telefono: tienda10?.acf?.telefono,
        ...
        },
        {
            ...
            telefono: tienda11?.acf?.telefono,
...
async function getStaticProps() {
    ...
    const res6 = await fetch(`https://panel.quickgold.es/wp-json/acf/v3/pages/${id6}`);
    const tienda6 = await res6.json();
    const res7 = await fetch(`https://panel.quickgold.es/wp-json/acf/v3/pages/${id7}`);
    const tienda7 = await res7.json();
    const res8 = await fetch(`https://panel.quickgold.es/wp-json/acf/v3/pages/${id8}`);
    const tienda8 = await res8.json();
    const res9 = await fetch(`https://panel.quickgold.es/wp-json/acf/v3/pages/${id9}`);
    const tienda9 = await res9.json();
    const res10 = await fetch(`https://panel.quickgold.es/wp-json/acf/v3/pages/${id10}`);
    const tienda10 = await res10.json();
    const res11 = await fetch(`https://panel.quickgold.es/wp-json/acf/v3/pages/${id11}`);
    ...
    const google4 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_4}.txt`);
    const tienda4Google = await google4.json();
    const google5 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_5}.txt`);
    const tienda5Google = await google5.json();
    const google6 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_6}.txt`);
    const tienda6Google = await google6.json();
    const google7 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_7}.txt`);
    const tienda7Google = await google7.json();
    const google8 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_8}.txt`);
    const tienda8Google = await google8.json();
    const google9 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_9}.txt`);
    const tienda9Google = await google9.json();
    const google10 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_10}.txt`);
    const tienda10Google = await google10.json();
    const google11 = await fetch(`https://panel.quickgold.es/archivos-cache/archivos-cache-gmb/cached-place_id-${tienda_11}.txt`);
...
var __webpack_exports__ = __webpack_require__.X(0, [9210,2636,5675,29,1664,1581,3051], () => (__webpack_exec__(7797)));
